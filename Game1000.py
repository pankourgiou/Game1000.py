...
background = pygame.image.load("Game.png")  # Make sure you have an image file
...
locations = [
    {"name": "A", "event": "Playing white!!---> blue dots are white next moves but here it's not totally a chess game! we need allies!", "x": 350, "y": 450},
    {"name": "B", "event": "I like learning!", "x": 450, "y": 500},
    {"name": "C", "event": "we must change!", "x": 450, "y": 700},
    {"name": "D", "event": "Hello!we need health care in difficult times not a destroyed healthcare system!!", "x": 450, "y": 540},
]
